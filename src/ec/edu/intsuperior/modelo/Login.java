...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logoname.setText("DE NOTAS");
        bg.add(logoname, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 280, 290, 20));

        logoname1.setBackground(new java.awt.Color(255, 255, 255));
        logoname1.setFont(new java.awt.Font("Roboto Medium", 1, 18)); // NOI18N
        logoname1.setForeground(new java.awt.Color(255, 255, 255));
        logoname1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logoname1.setText("SISTEMA DE REGISTRO");
        ...
        bg.add(btnIngresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 130, 40));
        ...
        bg.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 390, 130, 40));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        String Usuario= "root";
        String Contraseña= "1724673262";
       
        
        String Pass= new String(passTxt.getPassword());
        if (userTxt.getText().equalsIgnoreCase(Usuario)&& Pass.equals(Contraseña)) {
